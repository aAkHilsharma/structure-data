...
# kg.query("CREATE INDEX vector IF NOT EXISTS FOR (n:Document) ON (n.embeddings) OPTIONS { indexProvider: 'vector-1.0', embeddingDimensions: 768 };")
